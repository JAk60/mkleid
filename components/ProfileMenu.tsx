...
export default function ProfileMenu() {
  ...
  return (
    <Menu as="div" className="relative ml-3">
      <div>
        <Menu.Button className="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm">
          ...
          <svg
            ...
            strokeWidth="{1.5}"
            stroke="currentColor"
            className="w-7 h-7 bg-[#E3D9C6] rounded-full"
          >
            <path
              strokeLinecap="round"
      ...
      >
        <Menu.Items className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-[#E3D9C6] py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
